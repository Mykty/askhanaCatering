...
public class DinnerFragment extends Fragment implements View.OnClickListener {
    ...
    public void setupViews() {
        ...
        expCalendarView = view.findViewById(R.id.calendar_exp_lunch);
        ...
        mDatabaseRef = mDatabaseRef.child("payed").child("college").child(idNumber).child("dinner");
        ...
        calendarPicker.setOnDateSelectedListener(new CalendarPickerView.OnDateSelectedListener() {
            ...
            public void onDateSelected(Date date) {
                if(!highlightDatesList.contains(date)){
                    ...
                    Toast.makeText(getActivity(), getResources().getString(R.string.dinnerSelected), Toast.LENGTH_LONG).show();
        ...
        expCalendarView.setOnDateClickListener(new OnDateClickListener() {
            ...
            public void onDateClick(View view, DateData date) {
                ...
                if(markedDatesStore.contains(conDate)) {
                    ...
                    selectedDateStr = getResources().getString(R.string.title_dinner)+": "+pressedDate;
        ...
        switch (v.getId()){
            case R.id.btnReplace:
                ...
                if(calendarPicker.getSelectedDate() != null && newDaySelected) {
                    ...
                    alertDialogEditing.setTitle(getString(R.string.title_dinner)+" "+getString(R.string.replace2));
