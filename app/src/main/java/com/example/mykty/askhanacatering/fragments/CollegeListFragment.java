...
public class CollegeListFragment extends Fragment implements View.OnClickListener {
    ...
    Button choosePhotoBtn, scannerQrCodeBtn, addNewStudentBtn;
...
//                startActivityForResult(t, 101);
            ...
            case R.id.btnOk:
                ...
                if (tOk) {
                    uploadImageAndRegisterStudent(sGroup, sName, sCardN, returnedResult);
                }
    ...
    private class RecyclerDataAdapter extends RecyclerView.Adapter<RecyclerDataAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(RecyclerDataAdapter.MyViewHolder holder, int position) {
            ...
            textViewTotal.setText(getResources().getString(R.string.all_title) + " " + totalCount);
        }
            ...
            public void onClick(View view) {
                if (view.getId() == R.id.tv_parentName) {
                    ...
                    if (isNetworkAvailable(getActivity())) {
                        ...
                        Intent intent = new Intent(getActivity(), CollegeStudentCab.class);
